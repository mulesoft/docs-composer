...
For NetSuite Connector and Salesforce Connector, select the gear icon and then select `Clear on Null Values` to clear the existing value of the field when the field value is null.
