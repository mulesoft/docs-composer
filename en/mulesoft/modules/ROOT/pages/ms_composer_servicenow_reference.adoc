...
Only users with the ServiceNow `soap_admin` role can create connections. For more information, see the https://www.servicenow.com/community/itsm-forum/getting-error-quot-insufficient-rights-for-creating-new-records/m-p/704152[ServiceNow documentation].
