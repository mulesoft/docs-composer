...
After creating the flows, xref:ms_composer_test_flows.adoc[test the flows] to ensure that the RPA process completes in less than three minutes for each flow.
