...
Searches for an existing invoice. The following field is required: *SQL ID*. Additionally, one or more of the following fields must be populated to return results:
...
Searches for an existing customer. The following field is required: *SQL ID*. Additionally, one or more of the following fields must be populated to return results:
Customer Id Equals
...
Searches for an existing item. The following field is required: *SQL ID*.
