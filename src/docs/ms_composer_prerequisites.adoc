...
* Browser prerequisites:
     ...
     ** As described in https://developer.salesforce.com/docs/atlas.en-us.platform_connect.meta/platform_connect/canvas_framework_supported_browsers.htm[Salesforce documentation], for Safari browsers,
ensure that you have unchecked the *Prevent cross-site tracking* option.
