...
For more about Salesforce connected apps and authorization, see the https://help.salesforce.com/articleView?id=remoteaccess_request_manage.htm[Salesforce documentation].
