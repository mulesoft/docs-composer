...
//* Required fields in Composer are now denoted with an asterisk (*).

//WRITER NOTE: As both of these are added, consolidate into a single RN with the text "...connect to two new systems: Salesforce Marketing Cloud Connector and HubSpot Connector."
