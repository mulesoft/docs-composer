...
You can test your work after every trigger and action. As you test, you can add or delete actions and flow controls. You can also change the connection you use in triggers or actions to another connection of the same system type.
