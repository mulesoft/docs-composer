...
Composer supports adding custom fields to Sage Intact connector. For details on adding custom fields, see the https://developer.intacct.com/customization-services/#custom-fields[Sage Intacct documentation].
