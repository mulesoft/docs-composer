...
. Choose one of the time intervals, from 15 minutes to 30 days. If you select an interval that is a day or more, the scheduler runs once per day interval; however, it may not run at the same time each day. 
+
