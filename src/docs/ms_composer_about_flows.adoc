...
The first step in triggering a flow is connecting to the system where the trigger will occur. In the What Should Start This Flow page, choose or create a connection as the first step of creating a trigger:
