...
* To use Google Sheets Connector, you must have a https://support.google.com/a/users/answer/9389764?hl=en&ref_topic=9296556&sjid=17545113492625404882-NA[Google Workspace] account. Connections from Composer to personal Google accounts are not permitted. 
+
