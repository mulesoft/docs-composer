...
|*Filtering Parameter* |Free text, string, data pill |Field to define how this trigger is used. This field is defined by the user in the *Query Parameter* or the *Header* field.
