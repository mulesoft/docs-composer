...
* Jackson dependency has been upgraded for HTTP Connector.
...
|Fixed the issue in HTTP Connector in which OAuth 2.0 refresh tokens from Spotify were not valid. |W-11437322
