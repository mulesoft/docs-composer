...
//== October 19, 2023 - Copy to SF Composer 

//include::_partials/release-notes/rn-headings.adoc[tag=whatsNew,leveloffset=+3]

//* When defining a variable, the `List<Primitive>` and `List<Object>` data types are now available. Additionally, you can append or prepend items to your `List` variable using either dynamic or static list mappings. 
