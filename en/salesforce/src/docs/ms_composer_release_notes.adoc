...
* In the Google Sheets Connector, you can now transfer multiple rows of data.
...
| Fixed the issue in the Google Sheets Connector, when using Google Sheets as the trigger and Salesforce as the action, trigger fields with the text data type were being incorrectly mapped to actions. | SE-227701, COCN-575
