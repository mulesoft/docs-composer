...
If you need help with permissions, see xref:sf.perm_sets_assigning.htm[xref-html]

If you need help with permissions, see link:sf.perm_sets_assigning.htm[link-html]

If you need help with permissions, see link:https://help.salesforce.com/articleView?id=sf.perm_sets_assigning.htm&type=5[link-fullURL]
