...
* A new page, *Connections*, is available in the navigation pane. Using this page, you can easily view connections, view the flows currently using each connection, delete connections, and modify the names of connections. 
