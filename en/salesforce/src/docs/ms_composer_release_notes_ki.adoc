...
The following list displays Known Issues and Limitations for Composer for Salesforce. The list is sorted by the date in which the issue or limitation appeared.
