...
. In the *Assign Users to MuleSoft Composer* section, click the *Assign Users* button to go directly to the Salesforce *Permission Sets* page:
   ...
   ... *Composer User* has general access to Composer funcionality such as building and managing flows. 
...
. In MuleSoft Composer for Salesforce, in the top of the page, click the gear icon. +
The *Setup* page appears. 

. In the navigation pane, under *Platform Tools*, select *MuleSoft* > *Services*.  
The *MuleSoft Services* page appears.
...
. Log in to Anypoint Platform. Ensure that the user logging into Anypoint Platform has the right xref:2.x@api-manager::access-client-app-id-task[permissions to create a client app].
