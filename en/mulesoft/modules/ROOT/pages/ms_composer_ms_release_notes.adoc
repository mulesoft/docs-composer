...
* If a Compposer connector supports a default value for a field, that value now appears and is selected in the Composer UI; however, the user can choose to override the default value.
