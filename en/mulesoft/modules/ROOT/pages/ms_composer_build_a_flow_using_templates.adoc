...
For more information about how to create a new flow from template, refer to xref:ms_composer_using_a_flow_and_creating_trigger.adoc.adoc#create-a-new-flow-from-template[Create a New Flow From Template].
