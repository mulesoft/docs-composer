...
* You can type in a field and matching data pills are returned in a dropdown. You can enter a single term or enter multiple terms separated by commas. You can type characters, dates, booleans, or numbers. 
