...
. In the *Configure MuleSoft Services* section, click *Initiate Configuration*. Salesforce certificates expire after one year. To renew an expired certificate, click *Initiate Configuration*.
+
