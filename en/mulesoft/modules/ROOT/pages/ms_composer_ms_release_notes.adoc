...
* You can now define a variable as temporary storage in your flow and use it as a data pill. Defining a variable allows you to complete certain use cases like aggregating calculations and storing values. Variables are defined locally within a flow and can be used anywhere within that flow.
