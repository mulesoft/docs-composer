...
In MuleSoft Composer, the Anypoint Platform control and runtime plane for an organization is selected by the AE at provisioning time (during the quoting process). Users cannot change the mapping. MuleSoft Composer is available in the US East (N. Virginia) and EU (Frankfurt) regions.
