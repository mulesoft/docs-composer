...
|===
|Issue Resolution |ID
|In RPA Connector, the *RPA Process Execution Completed* trigger no longer fails every few seconds with an `UNKNOWN ERROR`. |  W-13697777
|===
