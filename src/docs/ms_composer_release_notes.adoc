...
* You can now connect to two new systems: Zendesk and QuickBooks Online.
+
...
|If you encounter an error while testing, instructions now appear in the *Test stopped unexpectedly* window to download the HAR file and to contact support. | CAPO-364
