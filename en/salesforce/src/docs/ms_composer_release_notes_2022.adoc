...
|===
|Issue Resolution |ID
|The com.fasterxml.jackson.core library is upgraded to version 2.13.4.1 to address reported security vulnerabilities.| W-11933496
|The connection no longer breaks when Zendesk triggers are idle for long durations when deployed on CloudHub.| W-12040415
|===
