Field'sRelease Notes for MuleSoft Composer for Salesforce
...
* The following JIRA triggers and actions were renamed:
** Triggers
*** *Updated issue* to *Updated issue with Custom Fields*
*** *New issue* to *New issue with Custom Fields*
** Action: *Update Issue* to *Update Issue with Custom Fields*

* The following JIRA triggers and actions are now available:
** Triggers
