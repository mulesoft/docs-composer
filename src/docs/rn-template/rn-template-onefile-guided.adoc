...
Use this template for RNs with one release (major.minor.patch) per file,
including those with monthly updates, such as Mule runtime releases.
...
////
<ReleaseDate> is required as the first H2.

This date is the date the product is released. If a product is released in the EU before in the US, the date is the EU release date.
Use this format:
...
include::partial$rn-template/rn-headings.adoc[tag=whatsNew,leveloffset=+1]
...
include::partial$rn-template/rn-headings.adoc[tag=compatibility,leveloffset=+1]
...
include::partial$rn-template/rn-headings.adoc[tag=fixedIssues,leveloffset=+1]
...
include::partial$rn-template/rn-headings.adoc[tag=knownIssues,leveloffset=+1]
...
include::partial$rn-template/rn-headings.adoc[tag=upgrade,leveloffset=+1]
...
include::partial$rn-template/rn-headings.adoc[tag=seeAlso,leveloffset=+1]
