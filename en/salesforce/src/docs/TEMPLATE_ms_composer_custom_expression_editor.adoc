...
. Click *Edit*
. In the action, in a field, select *Custom Expression fx* from the drop down. +
...
The selections appear in the *<Field Name>* text box of the *Custom Expression Editor*. The syntax of the custom expression is validated automatically.
. Optionally, if you know the custom expression that you want to add, you can enter it manually in the *<Field Name>* text box of the *Custom Expression Editor*.
. After the custom expression is created and validated, click *Apply*.
. In the *Flow Details* page, click *Save*. +
...
. From the *Composer Flows* tab, open a flow.
. Click *Edit*
. In the action, in a field containing a custom expression, click the pencil. +
The *Custom Expression Editor* appears.
. In the *<Field Name>* text box of the *Custom Expression Editor*, select and delete the existing custom expression or place your cursor where you would like add additional items from the left pane.
...
. From the *Composer Flows* tab, open a flow.
. Click *Edit*
. In the action, in a field containing a custom expression, click the X. +
The custom expression is cleared. If a value in the field is required, you will need to either add a new custom expression or select a value from the drop down.
. In the *Flow Details* page, click *Save*. +
