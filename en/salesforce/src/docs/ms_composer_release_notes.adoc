...
| When adding a For Each block to a flow control in the Salesforce connector, the For Each block returns the object label name instead of the object API name. | COCN-745
