...
Organizations that use both MuleSoft Composer and Anypoint Platform can connect the two products to unlock additional capabilities.

To link Composer to Anypoint Platform:

* In Anypoint platform, open xref:access-management::managing-your-account.adoc[*Access Management*].
* In the left pane, click *Composer Sync*.
