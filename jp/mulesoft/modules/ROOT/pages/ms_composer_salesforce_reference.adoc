...
項目レベルの暗号化についての詳細は、&#8203;https://help.salesforce.com/s/articleView?id=sf.mc_overview_field_level_encryption_limitiations.htm&type=5[Salesforce のドキュメント]を参照してください。
