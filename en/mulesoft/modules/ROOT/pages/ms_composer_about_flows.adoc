...
Data pills contain the complexity of a data structure, making it easy map data from triggers or previous actions. Using data pills, data mapping to be as simple or as complex as you need:
