...
. Go to *Public Web Service*.
. Click on *...* and select *Web Service > View WSDL*. Check `soapbind:address` to ensure you are using the correct host name, for example, `<soapbind:address location=”https://hostname/ccx/.... />`. The tenant name is displayed in the upper bar.
