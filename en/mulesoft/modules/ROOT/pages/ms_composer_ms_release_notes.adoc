...
|===
|Issue Resolution |ID
|Previously, when opening a flow, all steps of the flow were open by default. Now, when you open a flow, all steps aside from If/Else Blocks and For Each Loops are collapsed to provide a navigable outline of the flow |W-12515426
|===
