...
//* MuleSoft Composer for Salesforce now enables the List of Strings data pill. You can now type characters, dates, booleans, or numbers into a field and a list of matching strings is returned in a dropdown.  

== January 5, 2022

nclude::_partials/release-notes/rn-headings.adoc[tag=fixedIssues,leveloffset=+3]
