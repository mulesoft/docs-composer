...
|Some API endpoints expect a list as input. Composer only support creating one list from another. |Add a previous step that returns a list to your flow and use it as a basis for the list required in the HTTP request. |
