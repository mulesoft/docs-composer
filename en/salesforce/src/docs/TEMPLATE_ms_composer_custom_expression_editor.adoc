...
. Click *Edit*
. In the action, in a *Custom Expression fx* field, click the pencil. +
...
. In the *Custom Expression Editor*, in the left pane, click the *Function*, *Data*, or *Operators* tab to see or search for the available string, number, or date parameters available for the selected field.
.  Click the parameters you want to add. +
The selected parameters appear in the *Total Amount* box.
. Optionally, you can enter the parameters manually in the *Total Amount* box.
. Once you have added all the parameters to your expression, select *Check Syntax*.


fuction, data --> field and/or data pill, operators
