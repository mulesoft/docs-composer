...
* The *Composer Administrator* permission set is now available. During the installation of Composer, the user completing the installation will automatically be assigned this permission. With this permission set, you can adjust the permissions of other users within your organization and view the *Settings* page.
