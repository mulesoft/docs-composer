...
Monitors one sheet within a spreadsheet, and triggers when a new row is added at the end of the sheet. When flow starts for the first time, this trigger will pick up all existing rows in the sheet. Subsequently, the trigger will pick up new rows added at the end of the sheet.

Updated row in sheet::

Monitors one sheet within a spreadsheet. Triggers when a row is added or updated in a worksheet. On flow start, this trigger will pick up all existing rows in the sheet. Subsequently, the trigger will pick up a new row or updated row in the sheet.
