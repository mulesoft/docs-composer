...
* The NetSuite connector now supports NetSuite Financial objects. To support this feature, new record types are now available.

* In the Slack connector, selecting the channel name no longer fails during the *Create message* action when you connect to a workspace that contains hundreds of channels.
//COCN-539

=== Fixed Issues

* The *Get channels* action no longer fails when connecting to the salesforce-internal workspace.
//COCN-539
...
inlcude::_partials/platform-ki.adoc[]
