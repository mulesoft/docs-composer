...
numCharacters: Number|String |String
...
`fromStringToNumber(0.05) = 0.05` |text |text: String |Number
...
`fromNumberToString(0.05) = 0.05` |Number |number: Number |String
...
unit (optional) |number: Number |unit: String |DateTime
...
`fromDateToString(2021-03-15, eeee, dd MMMM, ES) = lunes, 15 marzo` |date +

format (optional) +

locale (optional) |date: Date +
...
`fromDateTimeToString(2021-03-15T23:57:59Z, MMMM dd, ES) = marzo 15` |dateTime +

format (optional) +

locale (optional) |dateTime: DateTime +
...
`fromDateTimeToNumber(2015-10-01T23:57:59Z, milliseconds) = 1443743879000` |dateTime +

unit (optional) |dateTime: DateTime +
...
`fromDateToDateTime(2021-03-15, T23:57:59Z) = 2021-03-15T23:57:59Z` |date +

time (optional) |date: Date +
