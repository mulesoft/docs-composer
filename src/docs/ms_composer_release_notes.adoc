...
The NetSuite connector now supports NetSuite Financial objects.
To support this feature, the following are now available:

* Objects
** Opportunity
** Estimate
* Attributes
** Connectors Model Service - ListMappingValue
** Adapter Service - ArrayFieldContent
