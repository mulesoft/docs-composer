...
* The NetSuite connector now supports the `External ID` field for the *Update Record* action.

* The NetSuite connector now supports the `ID Type` values for the *Delete Record* action.
