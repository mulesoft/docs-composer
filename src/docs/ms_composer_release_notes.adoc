...
The Xero connector now supports the *Create or update invoice* action. Additionally, the Xero connector also supports a list of objects for the *Create or update invoice* action and the *Contact Persons* field.
