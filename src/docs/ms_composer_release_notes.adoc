...
* After creating a case in JIRA, the *Update issue* action does not update the value in the *Reporter* field. To update the value in the *Reporter* field, you can manually update the case record in JIRA.

* If custom fields fail to load, reset your JIRA connection by deleting the connection and re-authenticating your JIRA account.
