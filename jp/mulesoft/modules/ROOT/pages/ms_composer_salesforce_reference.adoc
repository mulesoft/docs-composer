...
+
image::images/change-connection.png["[Change the Connection (接続を変更)] ボタン", 500]
...
+
image::images/get-records-salesforce.png["Salesforce Connector の [Get Records (レコードの取得)] サンプルアクション設定", 500]
+
