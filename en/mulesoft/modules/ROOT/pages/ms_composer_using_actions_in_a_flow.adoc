...
* The mapping is stored at the organization level and can be reused across flows. No additional steps are required to reuse mappings across different flows compared to within the same flow.
