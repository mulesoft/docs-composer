...
The default format is `uuuu-MM-dd` and the default locale is US; however, these defaults can be modified.

|`fromStringToDate(2021-03-15, uuuu-MM-dd, US) = 2021-03-15` +

`fromStringToDate(2021/15/03, uuuu/dd/MM, US) = 2021-03-15`
|Format: The formatting to use on the date value. This parameter accepts Java character patterns based on ISO-8601. A Date value, such as `2011-12-03`, has the format `uuuu-MM-dd`. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES`.
...
The default format is `uuuu-MM-dd'T'HH:mm:ss'Z` and the default locale is US; however, these defaults can be modified. |`fromStringToDateTime(2021-03-15T23:57:59Z, uuuu-MM-dd'T'HH:mm:ss'Z,US) =  2021-03-15T23:57:59Z` +

`fromStringToDateTime(2021-03-15 23:57:59Z,uuuu-MM-dd HH:mm:ssz, US) = 2021-03-15T23:57:59Z`

|Format: The formatting to use on the dateTime value. This parameter accepts Java character patterns based on ISO-8601. A DateTime value, such as `2011-12-03T10:15:30.000000+01:00`, has the format `uuuu-MM-dd HH:mm:ssz`. +
...
Format: Optional formatting to apply to the value. A format accepts `#` or `0` (but not both) as placeholders for decimal values and a single whole number that is less than `10`. Only one decimal point is permitted. Other characters produce an error. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES`. |text: String |Number
...
`fromNumberToString(0.05) = 0.05` |Format: Optional formatting to apply to the value. A format accepts `#` or `0` (but not both) as placeholders for decimal values and a single whole number that is less than `10`. Only one decimal point is permitted. Other characters produce an error. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES`. |number: Number |String
...
`fromDateTimeToNumber(1443743879000, milliseconds) = 2015-10-01T23:57:59Z` |number +

unit (optional) |Format: The formatting to use on the dateTime value. This parameter accepts Java character patterns based on ISO-8601. A dateTime value, such as `2011-12-03T10:15:30.000000+01:00`, has the format `uuuu-MM-dd HH:mm:ssz`. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES` |unit: String |DateTime
...
|fromDateToString |Transforms a date input value into a string value. Accepts a format and locale. The format parameter represents the required format of the output string. The default format is `uuuu-MM-dd` and the default locale is US; however, these defaults can be modified. |`fromDateToString(2021-03-15, uuuu-dd-MM, US) = 2021-15-03` +

`fromDateToString(2021-03-15, uuuu/MM/dd, US) = 2021/03/15` +

`fromDateToString(2021-03-15, eeee, dd MMMM, ES) = lunes, 15 marzo` |Format: Optional formatting to apply to the value. A format accepts `#` or `0` (but not both) as placeholders for decimal values and a single whole number that is less than `10`. Only one decimal point is permitted. Other characters produce an error. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES`. |date: Date +

format: String +

locale: String |String

|fromDateTimeToString |Transforms a dateTime input value into a string value. Accepts a format and locale. The format parameter represents the desired format of the output string. The default format is xxx and the default locale is US; however, these defaults can be modified. |`fromDateTimeToString(2021-03-15T23:57:59Z, uuuu-MM-dd'T'HH:mm:ss'Z, US) = 2021-03-15T23:57:59Z` +

`fromDateTimeToString(2021-03-15T23:57:59Z, MMMM dd, ES) = marzo 15` |Format: Optional formatting to apply to the value. A format accepts `#` or `0` (but not both) as placeholders for decimal values and a single whole number that is less than `10`. Only one decimal point is permitted. Other characters produce an error. +

Locale: Optional ISO 3166 country code to use, such as `US`, `AR`, or `ES`. |dateTime: DateTime +
...
`fromDateTimeToNumber(2015-10-01T23:57:59Z, milliseconds) = 1443743879000` |Format: Optional formatting to apply to the value. A format accepts `#` or `0` (but not both) as placeholders for decimal values and a single whole number that is less than `10`. Only one decimal point is permitted. Other characters produce an error. +
...
`fromDateToDateTime(2021-03-15, T23:57:59Z) = 2021-03-15T23:57:59Z` |Format: The formatting to use on the dateTime value. This parameter accepts Java character patterns based on ISO-8601. A dateTime value, such as `2011-12-03T10:15:30.000000+01:00`, has the format `uuuu-MM-dd HH:mm:ssz`. +
