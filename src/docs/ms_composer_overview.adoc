...
+
Using the triggers and actions of Mulesoft Composer for Salesforce, you can make the flow as elaborate or as simple as you need.
+
...
Once activated, the flow automatically runs when the conditions in the trigger are met.
