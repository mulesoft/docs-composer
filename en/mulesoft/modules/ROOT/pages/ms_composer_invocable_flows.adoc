...
+
. Optionally, add output fields. If specified, output fields are returned as the JSON response. For example, if there is an `Opportunity ID` input field, you can add `{"opportunityId": "<id>"}` as an output field. 
+
