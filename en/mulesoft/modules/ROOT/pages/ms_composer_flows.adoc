...
. Enter the requested criteria. You can specify that `all conditions should be met (AND)`, `any condition can be met (OR)`, or define <<use-custom-logic,custom logic>> to customize the order and grouping of your conditions.
