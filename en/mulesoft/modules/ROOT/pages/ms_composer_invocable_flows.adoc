...
. Click *Next*.
. Configure the fields to test your HTTP connection. For *Request Body*, enter the input fields of the invocable flow. For more information about testing your HTTP connection, refer to xref:ms_composer_http_reference.adoc#test-the-connection[Test the Connection]. 
. Click *Connect*.
