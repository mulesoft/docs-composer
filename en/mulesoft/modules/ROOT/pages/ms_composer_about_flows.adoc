...
The value that a field can accept for a value is a data types. In Composer, the following data types are available:
...
|Object | Referes to a reference of data of any type (`boolean`, `date`, `number`, etc.).
