...
* The mapping is stored at the organization level and can be reused across flows. You don't need to perform any extra steps when reusing mappings across different flows compared to reusing mappings within the same flow.
