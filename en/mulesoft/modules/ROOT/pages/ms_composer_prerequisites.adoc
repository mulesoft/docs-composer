...
Organizations who own MuleSoft Composer and Anypoint Platform can connect the two products to unlock additional capabilities.

To link Composer to Anypoint Platform:

* In *Access Management*, in the left pane, click *Composer Sync*.
* In the *Composer Sync Orgs* page, click *Add Composer Orgs*.
* In the *Add organization* window, int he *Organization ID* box, enter your Composer Organization and then click *Add*.
