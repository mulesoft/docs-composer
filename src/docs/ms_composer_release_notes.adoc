...
//* MuleSoft Composer for Salesforce now enables you to repair a lost OAuth connection by issuing using refresh tokens that do not require you to reconnect.
...
//include::_partials/googlecalendar-ki.adoc[]
...
* Restrictions for mapping a list of objects have been lifted in the connectors. You can now map to any top level field, regardless of the list of object selected.
