...
//* You can now connect to a new system: Google Calendar.
//+
...
//* The *Get Invoices* action and the *On New or Updated Invoices* trigger are now available for the Zero Connector.
