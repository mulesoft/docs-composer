...
include::_partials/rn-headings.adoc[tag=compatibility,leveloffset=+2]
...
include::_partials/rn-headings.adoc[tag=fixedIssues,leveloffset=+2]
...
include::_partials/rn-headings.adoc[tag=knownIssues,leveloffset=+2]
...
include::_partials/rn-headings.adoc[tag=upgrade,leveloffset=+2]

include::_partials/rn-headings.adoc[tag=seeAlso,leveloffset=+2]
