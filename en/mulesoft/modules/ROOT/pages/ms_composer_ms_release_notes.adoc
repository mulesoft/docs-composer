...
* The OAuth 2.0 Authorization Code grant for authentication in HTTP Connector now supports customizing the *Header Name*, *Value Prefix*, and *Custom Value Prefix* fields for the Authorization Header.

nclude::_partials/release-notes/rn-headings.adoc[tag=knownIssues,leveloffset=+3]
