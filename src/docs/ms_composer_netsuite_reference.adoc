...
//* *Consumer Key*: The *Consumer Key* value generated in NetSuite. You can generate a *Consumer Key* by navigating to *Setup* > *Integration* > *Manage Integrations*
//* *Consumer Secret*: The *Consumer Secret* value generated in NetSuite. This value is generated when generating a value for the *Consumer Key*.
//* *Token ID*: The *Token ID* generated in NetSuite.
//* *Token Secret*: The *Token Secret* generated with the Token ID in NetSuite.
