...
Using HTTP Connector, you can establish a connection with an https://auth0.com/intro-to-iam/what-is-oauth-2[OAuth 2.0 Authorization Code Grant^] to enable authorization. With this authorization, you can then access resources hosted by other apps such as Salesforce, Gmail, or Outlook 365.
...
|*Scopes* | `+companyinformation+`| For all available scopes, see https://www.fortnox.se/developer[OAuth 2.0 Scopes for Fortnox APIs^].
...
For more information, see https://www.fortnox.se/developer[Authentication].
...
|*Access Token Expired Code* | `401` |
.2+|Test HTTP Connection |*Request Method* | `Get` |
|*Request Path* | `+/gmail/v1/users/me/profile+` | For more information, see the https://developers.google.com/workspace/gmail/api/guides[Gmail API documentation^].
...
|*Access Token Expired Code* | `401` |
.2+|Test HTTP Connection |*Request Method* | `Get` |
|*Request Path* | `/v3/users/me/settings` | For more information, see the https://developers.google.com/workspace/calendar/api/guides/overview[Google Calendar API^] documentation.
...
| For more information, see the https://developers.google.com/workspace/drive/api/guides/api-specific-auth[Google Drive API-specific authorization and authentication information^] documentation.
...
|*Access Token Expired Code* | `401` |
.2+|Test HTTP Connection |*Request Method* | `Get` |
|*Request Path* |`/drive/v3/about?fields=user` | For more information, see the https://developers.google.com/workspace/drive/api/guides/api-specific-auth[Google Drive API-specific authorization and authentication information^] documentation.
...
|*Client ID* |`63ddf8b7-c7b0-40f9-804...` | For more information, see the https://developers.hubspot.com/docs/apps/legacy-apps/authentication/working-with-oauth[Hubspot documentation^].
...
* `+https://api.hubapi.com/application/settings/test/v1/actions/accounts-fetch+`
 ...
 |For more information, see the https://developers.hubspot.com/docs/apps/legacy-apps/authentication/oauth-quickstart-guide[Hubspot OAuth 2.0^] documentation.
...
|Step |Field |Example Value |Notes
.9+|Connect to your HTTP Account |*Connection Display Name* | `+Shopify at my.account@example.com (QA)+` | For more information, see the https://www.shopify.com/partners[Shopify Partner Program^].
|*Authorization Type*| `OAuth 2.0 Authorization Code` | The value in this field is fixed.
