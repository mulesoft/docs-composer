...
* If you encounter an error while testing, instructions now appear in the *Test stopped unexpectedly* window to download the HAR file and to contact support.
