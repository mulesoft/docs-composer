...
* In NetSuite Connector, empty field values are ignored by default; however, to clear empty values instead, you can now select the `Clear on Null Values` option.
