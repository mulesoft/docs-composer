...
.12+|Connect to your HTTP Account |*Connection Display Name* | `+Fort Nox at admin@1342287+` | This should be your user.
...
|Step |Field |Example Value |Notes
.12+|Connect to your HTTP Account |*Connection Display Name* | `+My QuickBooks connection+` |
|*Authorization Type*| `OAuth 2.0 Authorization Code` | The value in this field is fixed.
