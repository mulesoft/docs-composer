...
Composer allows you to save and test after every trigger, action, or flow control that's added to your flow. You can add or delete actions and flow controls wherever you see the plus sign in a circle.
