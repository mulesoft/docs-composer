...
* If a connector update or bug fix may cause interruptions to your flows, you will now receive an email describing these updates and outlining which flows should be stopped and reactivated to avoid flow failures.
