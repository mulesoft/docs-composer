...
+
If you chose to start the flow at a specified time interval, then you'll fetch data as part of the first action.

Step 4: Test your flow on one record::

As you define triggers and actions, you see sample data that helps you know that you are building the right steps.
