...
このトリガが起動すると、後続のステップで新しいメッセージを使用できるようになります。このトリガを使用するには、使用する特定のチャネルに Composer アプリケーションを追加する必要があります。詳細は  https://slack.com/help/articles/202035138-Add-apps-to-your-Slack-workspace[SLACK ドキュメント^]​を参照してください。 
