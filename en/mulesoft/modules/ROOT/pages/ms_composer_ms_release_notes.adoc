...
|===
|Issue |ID
|Fixed the issue in Jira Connector in which tests fail when fields are selected by removing the Result Filter. |W-11510054
|Fixed the issue in Jira Connector in which the number of Jira projects that appeared in a dropdown was limited. Now, all projects are retrieved. |W-11912169
|===
