...
|Fixed the issue in Rest Consumer Connector in which, even if the *Operation Values* field was completed, an error occurred indicating that a value was required. |W-12648223
