...
+
You can update this name later, if necessary, but if you choose instead to skip this step, the first time that you attempt to save, test, or activate the flow, you are first prompted to supply a flow name. Valid characters: A-Z, a-z, 0-9, space, -, ., _.
. Click *Save*.
...
. Click the pencil icon next to *Copy of _original flow name_* and give your flow a name. Valid characters: A-Z, a-z, 0-9, space, -, ., _.
+
