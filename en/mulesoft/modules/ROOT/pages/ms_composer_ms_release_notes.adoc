...
//Add this to the other RN page once verified in the wdf-core-group channel!! Be sure to run a build to verify whether or not the partial and the link in the partial are working properly.
...
|In the Workday Connector, the *Position Title*, *Supervisory Organization*, and *Location* fields are now optional in the *Create Worker* action. | W-10574483 COCN-612
