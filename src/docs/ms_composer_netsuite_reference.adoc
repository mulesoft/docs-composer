...
You can add custom fields to existing objects in NetSuite. MuleSoft Composer provides the ability to populate custom field values for Actions and retrieve custom values for Triggers entered into the NetSuite record.
