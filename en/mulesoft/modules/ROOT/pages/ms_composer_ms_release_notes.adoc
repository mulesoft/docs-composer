...
* In NetSuite Connector, empty field values are ignored by default; however,  if you want empty field values to be cleared, you can now select the `Clear on Null Values` option.
