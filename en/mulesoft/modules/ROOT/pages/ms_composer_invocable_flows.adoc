...
+
.. https://help.salesforce.com/s/articleView?id=xcloud.nc_create_edit_custom_auth_ext_cred.htm&type=5[Create and edit a custom authentication external credential].
.. https://help.salesforce.com/s/articleView?id=xcloud.nc_enable_ext_cred_principal.htm&type=5[Enable external credential principals].
.. https://help.salesforce.com/s/articleView?id=xcloud.nc_custom_headers_basic_auth.htm&type=5[Use basic authentication with named credentials].  
.. https://help.salesforce.com/s/articleView?id=xcloud.nc_create_edit_named_credential.htm&type=5[Create and edit a named credential]. 

. Register your external service by copying the API specification from the Composer flow as described in https://help.salesforce.com/s/articleView?id=platform.external_services_register_json.htm&type=5[Paste the JSON-formatted Schema Into Your Browser]. 
...
. Click *Save*.
. Debug the flow as described in https://help.salesforce.com/s/articleView?id=platform.flow_test_debug.htm&type=5[Debug a Flow in Flow Builder].
. Test the flow as described in https://help.salesforce.com/s/articleView?id=platform.flow_concepts_testing.htm&type=5[Test a Flow]. 
. Activate the flow as described in https://help.salesforce.com/s/articleView?id=platform.flow_distribute_activate.htm&type=5[Activate or Deactivate a Flow].  
...
+
Note that you must add the *Automated Process* user to the *Permission Sets* assignments. For more information, refer to https://help.salesforce.com/s/articleView?id=platform.perm_sets_manage_assignments.htm&type=5[Assign a Permission Set to Multiple Users]. 
...
* https://help.salesforce.com/s/articleView?id=platform.external_services_manage_your_mulesoft_anypoint_platform_connection.htm&type=5[Connect to MuleSoft Anypoint Platform in Salesforce]
...
. In the *Service* section, click the link in the https://help.salesforce.com/s/articleView?id=xcloud.nc_named_creds_and_ext_creds.htm&type=5[*Named Credentials*] field. 
