...
* In RPA Connector, you can now test an RPA process using sample data without actually invoking the RPA process.

* In RPA Connector, if you are connected to your RPA organization but no processes appear in the dropdown for the *RPA Process* field, you can now connect directly to your RPA Organization to see your processes by clicking the *Create an invokable run config from MuleSoft RPA* button.
