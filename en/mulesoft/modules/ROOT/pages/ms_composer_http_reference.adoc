...
NOTE: The HTTP response timeout is 10 seconds and cannot be changed.
...
If the header is *Content-Type: application/json*, then the minimum valid JSON ({}, [], "") is required as part of the request body.
