...
* You can type in a field and matching data pills are returned in a dropdown. You can enter a single term or enter multiple terms separated by commas. You can type characters, dates, booleans, numbers, strings, or list of strings.

* You can construct a list of strings with multiple data pills. These data pills are appended to the end of the list. For example, when constructing a list of strings, if you input a number data pill and a list of strings data pill, the number is appended to the end of the existing list.
