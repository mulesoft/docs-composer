...
If you don't specify a  https://developers.google.com/workspace/gmail/api/guides/labels[filter^], this trigger fires on all emails (received, sent, or drafts). To specify a filter, the following field is required:
