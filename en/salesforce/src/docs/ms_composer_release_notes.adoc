...
| Fixed the field labels in the Xero Connector to match those field names in the Xero APIs. | CSCA-1043
| Fixed the issue in which the *On new or updated contact* action in the Xero Connector sent out multiple Slack messages when updating more than one field in the contact. | CSCA-1042
