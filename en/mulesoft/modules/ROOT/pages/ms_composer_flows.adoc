...
. The *Run History* of the flow. Composer currently stores up to 1000 records per flow and no more than the last two weeks of data. For example, for a flow that produces 10 records per day, you can see the run history for the last two weeks of data (14 x 10 = 140 records). For a flow that produces 100 records per hour, you can see no more than 10 hours of the run history.
