...
|Step |Field |Example Value |Notes
.11+|Connect to your HTTP Account |*Connection Display Name* | `My Microsoft Teams connection` | Including the Microsoft Teams instance name aids in identifying the connection from a list.
|*Authorization Type*| `OAuth 2.0 Authorization Code`| The value in this field is fixed.
...
|Step |Field |Example Value |Notes
.12+|Connect to your HTTP Account |*Connection Display Name* | |
|*Authorization Type*| `OAuth 2.0 Authorization Code`| The value in this field is fixed.
|*Base URL* | |
|*Client ID* | |
|*Client Secret* | |
