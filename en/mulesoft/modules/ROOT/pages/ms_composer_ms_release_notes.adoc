...
* When adding a trigger or an action, a search bar now appears in the *System Action* and *System Event* windows. This search bar enables you to enter the specific name of connectors or shared APIs. You can then select the returned connector or shared API for use in your flow.  
