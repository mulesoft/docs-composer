...
|Selecting the channel name no longer fails when you connect to a workspace that contains more than 10,000 channels when using the *Create Message* action. |COCN-512
