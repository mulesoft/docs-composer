...
Returns a list of records based on specific search criteria. The following fields are required:
...
Using MuleSoft Composer, you can complete a custom search of NetSuite records using the *Get Records* action.

== Custom Objects

Using MuleSoft Composer, you can access custom object values for <STUFF> that you set in the NetSuite record.
