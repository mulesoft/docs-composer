...
|Fixed the issue in HTTP Connector in which if an error occurred when connected to Jira, the HTTP Connector did not retrieve the error reason; however, the error reason was provided in the Jira log. |W-11816468
|Fixed the issue in HTTP Connector that occurred in which flow tests ran indefinitely and returned errors when connected to Shopify. |W-11821763, W11819981
|===
