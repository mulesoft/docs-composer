...
After activating your flow, you can publish the flow to your Salesforce organization. You must have the xref:general::automation-credits-usage-and-rates.adoc[Automation Starter or Automation Advanced subscription package] to use this service. 
