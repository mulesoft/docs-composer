...
. In the header, click  (Setup) > *Setup*. 
...
. In the *Service* section, click the link in the *Named Credentials* field. 
. Click the link in the *External Credential* field. 
+
The flow information appears. 
. You can now map users to the permission set for the flow. 
//endif::[]
