...
To establish a connection from Composer to Xero, you must select the Xero organisation to which you want to connect in the *Organisations* field.
...
Checks for a submitted payment. Provide a value for the *Organisations* field.
...
Returns a list of contact records based on values entered. Provide a value for *Organisations*.
