...
.. *Created On*: The date on which the flow was created in the time zone set for your browser.
.. *Flow ID*: The ID of the flow. 
.. *Flow Owner*: The owner of the flow. 
.. *Last Modified*: The date on which the flow was last modified in the time zone set for your browser.
.. *Status*: The status or the flow. The status can be either active or inactive.
. The *Run History* of the flow:
.. *Start Date*: The date on which the flow started in the time zone set for your browser.
.. *End Date*: The date on which the flow ended in the time zone set for your browser.
