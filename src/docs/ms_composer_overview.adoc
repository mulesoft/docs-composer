...
+
If you start the flow at a specified time interval instead of a trigger event, then you'll fetch data as part of the first action.
...
Nothing else changes until you activate the flow.
